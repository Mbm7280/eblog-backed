  ...
  <el-card class="main-card">
    ...
    <page-tools :show-before="true">
      <template slot="after">
        ...
        <el-button size="small" type="primary">公开</el-button>
        <el-button size="small" type="primary">私密</el-button>
        <el-button size="small" type="primary">草稿箱</el-button>
        <el-button size="small" type="primary">回收站</el-button>
      </template>
    </page-tools>
    ...
    <el-table border @selection-change="selectionChange" v-loading="loading">
